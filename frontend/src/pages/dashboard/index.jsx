...
export default function Dashboard() {
    ...
    const postState = useSelector((state) =>state.postReducer)  //postreducer or auth is the same name in store js
    useEffect(() => {
           ...
           <DashboardLayout>
            ...
            <div className={styles.wrapper}>
               ...
               <img className={styles.userProfile} 
                 ...
                 alt="Profile" 
                 />
                 <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent} placeholder={"What's in your mind ?"} className={styles.textAreaOfContent} name="posts" id="posts"></textarea>
                 ...
                 {post.media && (
                  ...
                  <div className={styles.optionContainer}>
                    ...
                    <div onClick={() => {
                      ...
                      const url = encodeURIComponent("https://x.com/home")
            ...
            <div 
              onClick={() =>{
                disPatch(resetPostId());//after click any part of background comment box gone
              }}
            className={styles.commentsContainer}>
               ...
               className={styles.allCommentsContainer}>
                ...
                <div className={styles.postCommentContainer}>
                  <input type="" value={commentText} onChange={(e) => setCommentText(e.target.value)} placeholder='Add a comment...'/>
                  <div onClick={async () => {
                    await disPatch(postComment({post_id: postState.postId, body: commentText}))//comments added
                    setCommentText("");//after comment added input field empty
                    await disPatch(getAllComments({post_id: postState.postId}))//after comment added get all comments again
